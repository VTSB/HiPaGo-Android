...
@Singleton
class QuerySplitter @Inject constructor() {
...
//        return query;
    ...
    fun getLastQuery(query: String): String? {
        ...
        return if (stringArray.size == 0) query else stringArray[stringArray.size - 1]
    }
    ...
    fun getChar(): Char {
        return when(mode) {
            ...
            1 -> ','
                ...
                Log.e(this::class.java.simpleName, "wrong splitMode(getChar): $mode")
                0.toChar()
            }
        }
    }
